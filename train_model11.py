...
np.save('result/{}/train_loss_fw.npy'.format(file_name),   history.history['out_fw1_loss'])
np.save('result/{}/test_loss_fw.npy'.format(file_name),    history.history['val_out_fw1_loss'])
...
np.save('result/{}/train_loss_dia.npy'.format(file_name),  history.history['out_d1_loss'])
np.save('result/{}/test_loss_dia.npy'.format(file_name),   history.history['val_out_d1_loss'])
np.save('result/{}/train_loss_area.npy'.format(file_name), history.history['out_la1_loss'])
np.save('result/{}/test_loss_area.npy'.format(file_name),  history.history['val_out_la1_loss'])
