...
np.save('result/{}/test_loss_fw.npy'.format(file_name),    history.history['val_fw_loss'])
np.save('result/{}/train_loss_dw.npy'.format(file_name),   history.history['out_dw_loss'])
np.save('result/{}/test_loss_dw.npy'.format(file_name),    history.history['val_dw_loss'])
np.save('result/{}/train_loss_h.npy'.format(file_name),    history.history['out_h_loss'])
np.save('result/{}/test_loss_h.npy'.format(file_name),     history.history['val_h_loss'])
np.save('result/{}/train_loss_dia.npy'.format(file_name),  history.history['out_dia_loss'])
np.save('result/{}/test_loss_dia.npy'.format(file_name),   history.history['val_dia_loss'])
np.save('result/{}/train_loss_area.npy'.format(file_name), history.history['out_area_loss'])
np.save('result/{}/test_loss_area.npy'.format(file_name),  history.history['val_area_loss'])
