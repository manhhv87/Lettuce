...
def Model_11(x, n_filters, layers, kernel_size, pool_size, dropout, units, n):
    ...
    out_fw1 = Dense(1, activation='linear', name='out_fw1')(x1)
    ...
    out_d1 = Dense(1, activation='linear',  name='out_d1')(x4)
    ...
    out_la1 = Dense(1, activation='linear',  name='out_la1')(x5)

    return [out_fw1, out_dw, out_h, out_d1, out_la1]
